...
#ifndef LIBVPL_SRC_WINDOWS_MFX_DRIVER_STORE_LOADER_H_
#define LIBVPL_SRC_WINDOWS_MFX_DRIVER_STORE_LOADER_H_
...
#endif // LIBVPL_SRC_WINDOWS_MFX_DRIVER_STORE_LOADER_H_
